...
/**
* BLAS level 1 routine to multiply a one-dimensional double-precision complex floating-point ndarray by a scalar constant.
*
* @module @stdlib/blas-base-ndarray-zscal
*
* @example
